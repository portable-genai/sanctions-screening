...
from sanctions_screening.domain.screening_service import (
    ScreeningService,
)
...
@pytest.fixture()
def screening_service(container: Container) -> ScreeningService:
    return build_screening_service(container)
