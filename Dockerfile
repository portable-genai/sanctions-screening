# Sanctions Screening Copilot (G2) serving image.
#
...
ENV PYTHONDONTWRITEBYTECODE=1 \
    ...
    SANCTIONS_PROFILE=gcp \
    SANCTIONS_SETTINGS=/app/config/settings.yaml \
    PORT=8080
...
CMD ["sh", "-c", "python -m sanctions_screening.managed_readiness && exec uvicorn sanctions_screening.api.app:app --host 0.0.0.0 --port ${PORT:-8080}"]
